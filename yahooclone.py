...
print ("\033[39m[\033[31m+\033[39m] Author : @Joshua_Ir$A")
print ("\033[39m[\033[31m+\033[39m] Youtube : VoltHz Official ")
idt = raw_input("\050[Hayy :v Username :imran ")
passw = raw_input("\070[Okeh:v Password : imran")
